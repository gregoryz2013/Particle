...
public class Main extends JFrame implements Runnable {
    ...
    public int selectedParticleType = 0;
...
//        this.setLocation(0, 0);
        ...
        KeyListener k = new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_F) {
                    addButterfly( (int) MouseInfo.getPointerInfo().getLocation().getX() - Main.this.getLocation().x,  (int) MouseInfo.getPointerInfo().getLocation().getY() - Main.this.getLocation().y);
                }
                if (e.getKeyCode() == KeyEvent.VK_R) {
                    glider( (int) MouseInfo.getPointerInfo().getLocation().getX() - Main.this.getLocation().x,  (int) MouseInfo.getPointerInfo().getLocation().getY() - Main.this.getLocation().y);
                }
                if (e.getKeyCode() == KeyEvent.VK_G) {
                    snake( (int) MouseInfo.getPointerInfo().getLocation().getX() - Main.this.getLocation().x,  (int) MouseInfo.getPointerInfo().getLocation().getY() - Main.this.getLocation().y);
                }
                if (e.getKeyCode() == KeyEvent.VK_T) {
                    addSpinner( (int) MouseInfo.getPointerInfo().getLocation().getX() - Main.this.getLocation().x,  (int) MouseInfo.getPointerInfo().getLocation().getY() - Main.this.getLocation().y);
                }
            }
    ...
    private void addButterfly(int x, int y) {
        Particle p1 = add(0, x - 4, y + 18);
        ...
        p1.bonds.add(p2);
        p2.bonds.add(p1);
        links.add(new Link(p2, p3));
        p2.links +=1;
        p3.links +=1;
        p3.bonds.add(p2);
        p2.bonds.add(p3);
        links.add(new Link(p2, p7));
        p2.links +=1;
        p7.links +=1;
        p7.bonds.add(p2);
        p2.bonds.add(p7);
        ...
        p7.bonds.add(p6);
        p6.bonds.add(p7);
        links.add(new Link(p8, p7));
        p8.links +=1;
        p7.links +=1;
        p8.bonds.add(p7);
        p7.bonds.add(p8);
        links.add(new Link(p8, p9));
        p8.links +=1;
        p9.links +=1;
        p9.bonds.add(p8);
        p8.bonds.add(p9);
    ...
    private void glider(int x, int y) {
        Particle p1 = add(0, x - 4, y);
        Particle p2 = add(2, x - 2, y);
        Particle p3 = add(2, x + 2, y);
        Particle p4 = add(0, x + 4, y);
        links.add(new Link(p1, p2));
        p1.links +=1;
        p2.links +=1;
        p1.bonds.add(p2);
    ...
    private void snake(int x, int y) {
        Particle p1 = add(0, x - 4, y);
        Particle p2 = add(2, x - 2, y);
        Particle p3 = add(2, x + 2, y);
        Particle p4 = add(1, x + 4, y);
        Particle p5 = add(1, x + 6, y + 2);
        Particle p6 = add(0, x + 6, y + 4);
        Particle p7 = add(1, x + 6, y - 2);
        Particle p8 = add(0, x + 6, y - 4);
        links.add(new Link(p1, p2));
        p1.links +=1;
        p2.links +=1;
        p1.bonds.add(p2);
        ...
        p4.bonds.add(p3);
        p3.bonds.add(p4);
        links.add(new Link(p4, p5));
        p5.links +=1;
        p4.links +=1;
        p5.bonds.add(p4);
        p4.bonds.add(p5);
        links.add(new Link(p4, p7));
        p7.links +=1;
        p4.links +=1;
        p7.bonds.add(p4);
        p4.bonds.add(p7);
        links.add(new Link(p5, p6));
        p6.links +=1;
        p5.links +=1;
        p6.bonds.add(p5);
        p5.bonds.add(p6);
        links.add(new Link(p7, p8));
        p8.links +=1;
        p7.links +=1;
        p8.bonds.add(p7);
        p7.bonds.add(p8);
    ...
    private void addSpinner(int x, int y) {
        Particle p1 = add(0, x - 4, y - 18);
        Particle p2 = add(1, x - 4, y + 0);
        Particle p3 = add(2, x - 4, y - -18);
        Particle p4 = add(0, x - 4, y - -28);
    ...
    private void drawScene(BufferedImage image) {
        ...
        for (Link link: links) {
            g2.setColor(link.a.getColor());
            g2.setStroke(new BasicStroke(100f / (float) Math.pow(Math.sqrt(Math.pow(link.a.x - link.b.x, 2) + Math.pow(link.a.y - link.b.y, 2)), 1.3)));
    ...
    private class MyMouseListener implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            add(selectedParticleType, (int) MouseInfo.getPointerInfo().getLocation().getX() - Main.this.getLocation().x, (int) MouseInfo.getPointerInfo().getLocation().getY() - Main.this.getLocation().y);
        }
    ...
    private class MouseWheelListener implements java.awt.event.MouseWheelListener {
        ...
        public void mouseWheelMoved(MouseWheelEvent e) {
            ...
            if (selectedParticleType > 2){
                selectedParticleType = 0;
            }
        }
    }
}